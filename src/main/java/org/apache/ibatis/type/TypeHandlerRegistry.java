...
public final class TypeHandlerRegistry {
    ...
    /**
     * 记录JdbcType与TypeHandler之间的对应关系，其中JdbcType是一个枚举类型，它定义了对应的Jdbc类型
     * 该集合主要用户从结果集读取数据时，将数据从Jdbc类型转化为Java类型
     */
    private final Map<JdbcType, TypeHandler<?>> jdbcTypeHandlerMap = new EnumMap<>(JdbcType.class);

    /**
     * 记录了Java类型向JdbcType转换时，需要使用的TypeHandle对象
     * 例如Java中String可能转化为数据库varchar、char等多种数据类型，存在一对多关系
     */
    ...
    /**
     * 记录了全部TypeHandler的类型一级该类型相应的TypeHandler对象
     */
